...
import { getAllCarReviews } from '../../../api/carReviewApi';
...
export default function CarReviewList() {
    const TABLE_HEADER = {
        id: "No.",
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true);
            try {
                const result = await getAllCarReviews();
                console.log("fetchData result: ", result);
                setCarReviews(result);
            } catch (error) {
    ...
    }, [carReviews, searchedCustomerName, searchedDriverLicenseNumber, searchBarData])
